...
- Seed and generator version: atlas metadata records both; generator version 3,
...
- Seed and generator version: atlas metadata records the deterministic seed;
  generator version 3, visual style `bright-comfortable`, format version 1
...
- Logical names: cow, pig, sheep, chicken, zombie, skeleton, spider, blastling,
  villager, zombie_villager, and item; semantic skins additionally include the
  player
...
- Creation date: 2026-07-27; semantic skins upgraded 2026-07-29; villager and
  zombie-villager materials added 2026-08-25
- Seed and generator version: atlas and skin metadata record seed, generator
  version 3, visual style, and format version
...
Generator version 5 also emits the adjacent entity action graphs. All ten
...
## Clean natural material revision (2026-09-05)

- Tool: `tools/texture_generator.py`, generator revision 3, seed 213785369.
- Scope: all generated block/item/entity PNGs and atlases; four species end-grain
  tiles, functional face tiles, semantic food/tool silhouettes and synchronized
  embedded entity/player skins.
- Original deterministic programmatic pixel art; no external pixels, models,
