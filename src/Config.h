...
constexpr int   CHUNK_CACHE_READ_TASKS_IN_FLIGHT = 2;
constexpr int   CHUNK_CACHE_WRITE_TASKS_IN_FLIGHT = 1;
constexpr int   CHUNK_CACHE_IO_QUEUE_LIMIT = 64;
constexpr int   CHUNK_PREFETCH_AHEAD = 1;
constexpr int   CHUNK_WARM_CACHE_LIMIT = 64;
constexpr double STREAMING_MAIN_BUDGET_MS = 2.0;
constexpr double LOADING_MAIN_BUDGET_MS = 8.0;
...
constexpr float PLAYER_CROUCH_EYE_HEIGHT = 1.27f;
constexpr float PLAYER_SWIM_HEIGHT = 0.6f;
constexpr float PLAYER_SWIM_EYE_HEIGHT = 0.4f;
constexpr float SNEAK_INPUT_FACTOR = 0.3f;
constexpr float MOUSE_SENSITIVITY = 0.15f;
constexpr float REACH_DISTANCE    = 6.0f;
constexpr float WATER_ACCELERATION_PER_TICK = 0.4f;
constexpr float WATER_CONTROL_ACCELERATION_PER_TICK = 0.8f;
constexpr float WATER_GRAVITY_PER_TICK = 0.4f;
constexpr float WATER_DRAG = 0.8f;
constexpr float WATER_SPRINT_DRAG = 0.9f;
constexpr float WATER_VERTICAL_DRAG = 0.8f;
constexpr float WATER_WALL_EXIT_SPEED = 6.0f;
