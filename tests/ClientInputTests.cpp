...
int main(){
    ...
    settings.renderDistance=8;settings.cloudRenderDistance=512;settings.smoothLighting=false;
    ...
    require(loaded.mouseSensitivity==.42f&&loaded.guiScale==3&&loaded.invertMouseY&&
            loaded.renderDistance==8&&loaded.cloudRenderDistance==512&&!loaded.smoothLighting,
